package com.opisek.freedsb.account;
...
import com.opisek.freedsb.activities.LoginActivity;
...
public class Authenticator extends AbstractAccountAuthenticator implements FetchIndexRequestTask.FetchIndexEventListener {
    ...
    public static final String ACCOUNT_TYPE = "com.opisek.freedsb.DSB";
    public static final String AUTHTOKEN_TYPE = "com.opisek.freedsb.Password";

...
import com.opisek.freedsb.adapters.TableViewAdapter;
import com.opisek.freedsb.viewmodels.TableviewViewModel;
...
public class TableviewViewFragment extends ContentViewerFragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle bundle) {
        ...
        if (getActivity() != null) {
            ...
            view.findViewById(R.id.tableBackground).setBackgroundResource(R.color.dark_bg);
        }
